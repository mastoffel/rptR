#' BeetlesBody dataset
#' 
#' @details This is an example dataset which was used as a simulated toy dataset for a different purpose 
#' (Nakagawa & Schielzeth 2013). 
#' It offers a balanced dataset with rather simple structure and sizable effects. 
